...
export const products = pgTable(
  "products",
  {
    ...
    // Real age, so the `newest` sort can mean what it says. It previously ordered by whether the
    // product carried the `new` *tag*, because this column did not exist; adminProductService
    // commented on the same gap and fell back to archivedAt.
